            ...
            <tr>
              ...
              <td>
                <div class="btn-group">
                  ...
                  <a href="includes\deletequestionario.inc.php?questId=<?php echo $linha['questId']?>&pid=<?php echo $linha['pid']?>" type="button" class="btn btn-outline-danger" ><i class="fa fa-trash-o" ></i> Apagar</a>
                </div>
              </td>
            </tr>
          <?php endwhile; ?>
